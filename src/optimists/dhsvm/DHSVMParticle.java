...
public class DHSVMParticle implements Particle
{
	...
	public DHSVMParticle(DHSVMAssimilator parent, String id, ArrayList<Double> sourceStateArray,
							ArrayList<Double> targetStateArray, State sourceState, 
							State targetState, ArrayList<Double> streamflow,
